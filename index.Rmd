...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/excel.jpg){width=90 height=90}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/1.1.png)
 
Make sure you save it as a `.csv`. file.
 
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/packages.png){width=240 height=50}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/importdata.png){width=240 height=50}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/preparedata.png){width=240 height=50}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/describedata.png){width=240 height=50}
```{r, eval = FALSE}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/modeldata.png){width=240 height=50}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/evaluatemodel.png){width=240 height=50}
```{r, eval = FALSE}
...
Well, here at RedCow we also want to introduce smaller bars 
Run the analysis using redcowchoc.csv, but this time the reference value is 30 grams.  
...
We will use the same ANOVA model from the previous exercise: `anova_result`
The model is the same, we are just going to use a planned contrast instead of post-hoc.
...
Let's view the levels of your data and the order they're in
This is important as we have to make sure the order matches our contrasts.
...
This was a 2x2 design. had it been 3x2 or 3x3 then we'd need to consider Sphericity... 
...which you will do next week.  
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/communicate.png){width=240 height=50}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/analysis_process.png){width=300 height=500}
...
![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/barchart.jpg){width=540 height=450}

![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/violinplot.jpg){width=540 height=450}

![](C:/Users/uejt014/OneDrive - Royal Holloway University of London/RHUL/PS2010_R/Materials/ws_code book/boxplot.jpg){width=540 height=450}
</details>
...
A violin plot with a box plot might also be useful. Particularly as box plots show the median and the density plot (the violin) can show us the distribution (i.e to see that the data are not normally distributed)
